...
.VERSION
    0.1 - Initial Version for reporting Lync/Skype4B
    0.3 - Initial Version for reporting Lync/Skype4B Users which reported with Poor Call quality Calls
    0.4 - Adding parameters for running remotely against a Front End Server, Change the design for a weekly view instead of a daily
...
'@	
		...
		[void]$sb.AppendLine("<tr><td colspan='3'><strong><center>Users Reported with Poor Call for $StartDate - $EndDate</cenetr></strong></td></tr>")
