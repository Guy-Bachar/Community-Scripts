...
{ param($ServersArray)
    ...
    foreach ($Computer in $ServersArray)
    {
        ...
        {
            Write-Host $Computer -ForegroundColor Red -NoNewline; Write-Host " - is not accessible and wil be removed from the list"
        }
    }
...
try
{
    ...
    Write-Host "`nRetrieving Certificate information from the FE Servers..." -ForegroundColor Yellow
...
if ($EdgeCertificates.IsPresent)
{
    ...
    {
        $S = New-PSSession -ComputerName $EDGEServer -Credential (Get-Credential -Message "Please enter your Edge Server's credentials" $EDGEServer\administrator)
...
if ($OWASCertificates.IsPresent)
{
    ...
    try
    {
        Write-Host "`nRetrieving Certificate information from the OWAS Servers..." -ForegroundColor Yellow
    ...
    Add-Content $ServicesFileName "<table width='100%'><tbody>"
    Add-Content $ServicesFileName "<tr bgcolor='#0080FF'>"
    Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=7><font face='segoe ui' color='#FFFFFF' size='2'><strong>$wacserver (Office Web Apps Server)</strong></font></td>"
    Add-Content $ServicesFileName "</tr>"
    WriteTableHeader $ServicesFileName
...
Add-Content $ServicesFileName "<table width='100%'><tbody>"
    ...
    Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=7><font face='segoe ui' color='#848484' size='2'>Script by <a href=https://twitter.com/guybachar target=_blank>Guy Bachar</a>, <a href=https://twitter.com/y0avb target=_blank>Yoav Barzilay</a> and <a href=https://twitter.com/CAnthonyCaragol target=_blank>C. Anthony Caragol</a></font></td>"
    Add-Content $ServicesFileName "</tr>"
