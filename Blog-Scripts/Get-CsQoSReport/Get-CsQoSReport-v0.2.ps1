...
.WHATSNEW
  ...
  0.2 - Background Color for Conferencing Ports ranges if not default
#> 
...
param($fileName,$Identity, $AudioPortStart, $AudioPortCount, $VideoPortStart, $VideoPortCount, $AppSharingPortStart, $AppSharingPortCount)
    ...
    Add-Content $fileName "<td width='8%' align='center'>Default Configurations</td>"
    ...
    if (($AudioPortStart -eq 49152) -and ($AudioPortCount -eq 8348) -and ($VideoPortStart -eq 57501) -and ($VideoPortCount -eq 8034) -and ($AppSharingPortStart -eq 49152) -and ($AppSharingPortCount -eq 16383))
    {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>TRUE</td>"}
    else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>FALSE</td>"}
    
    if ($AudioPortStart -eq 49152) {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>$AudioPortStart</td>"} else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>$AudioPortStart</td>"}
    if ($AudioPortCount -eq 8348) {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>$AudioPortCount</td>"} else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>$AudioPortCount</td>"}
    if ($VideoPortStart -eq 57501) {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>$VideoPortStart</td>"} else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>$VideoPortStart</td>"}
    if ($VideoPortCount -eq 8034) {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>$VideoPortCount</td>"} else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>$VideoPortCount</td>"}    
    if ($AppSharingPortStart -eq 49152) {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>$AppSharingPortStart</td>"} else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>$AppSharingPortStart</td>"}    
    if ($AppSharingPortCount -eq 16383) {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>$AppSharingPortCount</td>"} else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>$AppSharingPortCount</td>"}
...
param($fileName,$Identity, $AudioPortStart, $AudioPortCount)
    ...
    if (($AudioPortStart -eq 49152) -and ($AudioPortCount -eq 8348))
    {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>TRUE</td>"}
    else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>FALSE</td>"}
...
param($fileName,$Identity, $EnableQoS, $VoiceDiffServTag, $Voice8021p)
    Add-Content $fileName "<tr bgcolor=#CCCCCC>"
    Add-Content $fileName "<td width='20%' align='center'>Policy Name</td>"
    Add-Content $fileName "<td width='20%' align='center'>QoS Enabled for Lync?</td>"
    Add-Content $fileName "<td width='20%' align='center'>Default Configurations</td>"
    Add-Content $fileName "<td width='20%' align='center'>UC Phone DSCP Value</td>"
    Add-Content $fileName "<td width='20%' align='center'>Voice 802.1p Value</td>"
    Add-Content $fileName "</tr>"
    Add-Content $fileName "<tr>"
    ...
    if (($VoiceDiffServTag -eq 40) -and ($Voice8021p -eq 0))
    {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>TRUE</td>"}
    else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>FALSE</td>"}
...
{
param($fileName,$Identity, $ClientMediaPortRangeEnabled, $ClientMediaPort ,$ClientMediaPortRange ,$ClientAudioPort ,$ClientAudioPortRange `
     ,$ClientVideoPort ,$ClientVideoPortRange, $ClientAppSharingPort, $ClientAppSharingPortRange)
    Add-Content $fileName "<tr bgcolor=#CCCCCC>"
    Add-Content $fileName "<td width='11%' align='center'>Policy Name</td>"
    Add-Content $fileName "<td width='11%' align='center'>Default Configurations</td>"
    Add-Content $fileName "<td width='10%' align='center'>ClientMediaPortRangeEnabled</td>"
    Add-Content $fileName "<td width='9%' align='center'>ClientMediaPort</td>"
    Add-Content $fileName "<td width='8%' align='center'>ClientMediaPortRange</td>"
    Add-Content $fileName "<td width='9%' align='center'>ClientAudioPort</td>"
    Add-Content $fileName "<td width='8%' align='center'>ClientAudioPortRange</td>"
    Add-Content $fileName "<td width='9%' align='center'>ClientVideoPort</td>"
    Add-Content $fileName "<td width='8%' align='center'>ClientVideoPortRange</td>"
    Add-Content $fileName "<td width='9%' align='center'>ClientAppSharingPort</td>"
    Add-Content $fileName "<td width='8%' align='center'>ClientAppSharingPortRange</td>"
    Add-Content $fileName "</tr>"
    Add-Content $fileName "<tr>"
    Add-Content $fileName "<td align=center>$Identity</td>"

    if (($ClientMediaPortRangeEnabled -eq 0) -and ($ClientMediaPort -eq 5350) -and ($ClientMediaPortRange -eq 40) -and ($ClientAudioPort -eq 5350) -and ($ClientAudioPortRange -eq 40) -and ($ClientVideoPort -eq 5350) `
         -and ($ClientVideoPortRange -eq 40) -and ($ClientAppSharingPort -eq 5350) -and ($ClientAppSharingPortRange -eq 40))
    {Add-Content $fileName "<td bgcolor=#B2FFB2 align=center>TRUE</td>"}
    else {Add-Content $fileName "<td bgcolor=#FF9933 align=center>FALSE</td>"}
...
Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=8><font face='Segoe UI' color='#FFFFFF' size='2'><strong> QoS Conferencing Server Policy </strong></font></td>"
...
Add-Content $ServicesFileName "<tr bgcolor='#0099FF'>"
Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=4><font face='Segoe UI' color='#FFFFFF' size='2'><strong> Application Server Policy </strong></font></td>"
...
Add-Content $ServicesFileName "<table width='100%'>"
Add-Content $ServicesFileName "<tr bgcolor='#0099FF'>"
Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=4><font face='Segoe UI' color='#FFFFFF' size='2'><strong> Mediation Server Policy </strong></font></td>"
...
Add-Content $ServicesFileName "<table width='100%'><tbody>"
Add-Content $ServicesFileName "<tr bgcolor='#0099FF'>"
Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=5><font face='Segoe UI' color='#FFFFFF' size='2'><strong> Media Configuration & UC Phone Configuration Policy </strong></font></td>"
...
Add-Content $ServicesFileName "<table width='100%'><tbody>"
Add-Content $ServicesFileName "<tr bgcolor='#0099FF'>"
Add-Content $ServicesFileName "<td width='100%' align='center' colSpan=11><font face='Segoe UI' color='#FFFFFF' size='2'><strong> Conferencing Configuration Policy </strong></font></td>"
